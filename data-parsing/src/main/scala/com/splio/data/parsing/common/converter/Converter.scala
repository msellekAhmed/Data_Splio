package com.splio.data.parsing.common.converter

import com.splio.data.parsing.velib.data.converter.VelibDataConverter
...
object Converter {
  ...
  implicit def velibDataConverter = VelibDataConverter
}